...
appid = os.environ["SPARKAI_APP_ID"]    #填写控制台中获取的 APPID 信息
api_secret = os.environ["SPARKAI_API_SECRET"]   #填写控制台中获取的 APISecret 信息
api_key =os.environ["SPARKAI_API_KEY"]    #填写控制台中获取的 APIKey 信息
