...
def xh_api(option, user_appid, user_api_secret, user_api_key, user_gpt_url):
    global appid, api_secret, api_key, gpt_url
    if option == '使用我的api':
        appid = "b7dc84f2"
        api_secret = "MzNmOTdlNjc0ODEwM2JlZjY3MTVmMjJi"
        api_key = "5a6725b915894f04e1ce02ec05700ce1"
